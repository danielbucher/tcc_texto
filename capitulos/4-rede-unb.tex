...
servidor do CDTC, que já está disponível para acesso externo. A Fig. 3
...
da disciplina, para cada projeto da disciplina. A Fig. 4 (\ref{mes-unb})
...
A Fig. 5 (\ref{analizo}) apresenta o \textit{blog} do sub-grupo do sub-grupo
...
(Pantone 654) e o Verde UnB (Pantone 348). Na Fig. 3 (\ref{comunidade-unb})
...
(\ref{cronograma}). As atividades a serem realizadas são:
...
\begin{enumerate}
	...
	\item Pesquisa de satisfação dos alunos da disciplina de MES.
	\item Desenvolvimento da autenticação da Comunidade UnB.
	\item Colaboração no desenvolvimento do protocolo de federação selecionado.
	\item Desenvolvimento de novas \textit{features}.
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline
		\textbf{Atividades}	& \textbf{Ago 2013}	& \textbf{Set 2013}	& \textbf{Out 2013}	& \textbf{Nov 2013}	& \textbf{Dez 2013}	\\
		\hline\hline
