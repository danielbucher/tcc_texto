...
universidade compartilharem ideias, produzirem conteúdo de forma colaborativa
bem como publicá-lo para que possa ser de utilidade para outras pessoas ou parcelas da
...
colaborativa, como ocorreu, em nossos estudos de caso, em três disciplinas da UnB Gama.
%
...
%
Em outras palavras, dependendo do que for planejado para o Comunidade.UnB, o
Portal da FGA pode, no futuro e na prática, ser uma comunidade dentro do Comunidade.UnB,
...
para os desenvolvedores como um todo, brasileiros ou não) é a principal
...
diversos núcleos de desenvolvimento do Noosfero a par das últimas atualizações
...
cadastrar e mapear o desenvolvimento das funcionalidades e as correções de
...
item criado, outros usuários podem adicionar comentários e associar um
...
Antes das funcionalidades desenvolvidas (apresentadas na próxima seção),
...
e ajudar a formar uma equipe capacitada a contribuir com o Comunidade.UnB
e com o Noosfero no geral. No momento da escrita deste texto, foram criados
pelo menos 13 \textit{merge-requests}, levando em consideração as contribuições deste trabalho
